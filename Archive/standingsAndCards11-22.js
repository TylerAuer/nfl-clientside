...
xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
        ...
        for (i = 0; i < x.length; i++) {
            ...
            team = teams[x[i].childNodes[0].getAttribute("abbr")]
...
// #############################
// Updates the standings dict
// #############################

// Updates the points per team in the standings dict

// Updates the overall points in the standings dict
